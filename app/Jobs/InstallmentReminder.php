...
class InstallmentReminder implements ShouldQueue
{
    ...
    public function handle(): void
    {
      ...
      $date_adddays = $date_today->copy()->addDays(3);
      $date_subdays = $date_today->copy()->subDays(3);

      StudentProgramPaymentPlans::has('user')
      ->where('pay_status','pay')->whereBetween('sdate',[$date_subdays,$date_adddays])
      ->get();
      Log::info($users);
