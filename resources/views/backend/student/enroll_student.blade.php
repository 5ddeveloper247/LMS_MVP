                                            ...
                                            <div class="white_box mb_30">
                                                ...
                                                <form action="{{ route('admin.enrollFilter') }}" method="POST">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @if (Route::currentRouteName() == 'admin.enrollFilter')
                                                        <div class="col-md-3 col-xl-3 mt-30 ml-auto">
                                                            <div class="search_course_btn text-center">
                                                                <a href="{{route('admin.enrollLogs')}}">
                                                                <button type="button"
                                                                    class="primary-btn radius_30px fix-gr-bg mr-10 ml-auto">{{ __('Reset Filter') }}</button>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        @endif
                                            ...
                                            <form action="{{ route('admin.enrollFilter') }}" method="POST">
                                                ...
                                                <div class="row">
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="">
                                                                            <input placeholder="{{ __('common.Date') }}"
                                                                                ...
                                                                                name="start_date"
                                                                                value="{{ isset($start) ? (!empty($start) ? (date('Y-m-d', strtotime($start))) : '') : '' }}"
                                                                                autocomplete="off">
                                                                        </div>
                                                                    </div>
                                                                    <button class="" type="button">
                                                    ...
                                                    <div class="col-xl-4 col-lg-4">
                                                        <div class="primary_input mb-15">
                                                            <label class="primary_input_label"
                                                                for="admissionDate">{{ __('Enrollment') }}
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="">
                                                                            <input placeholder="{{ __('common.Date') }}"
                                                                                ...
                                                                                name="end_date"
                                                                                value="{{ isset($end) ? (!empty($end) ? date('Y-m-d', strtotime($end)) : '') : '' }}"
                                                                                autocomplete="off">
                                                                        </div>
                                                                    </div>
                                                                    <button class="" type="button">
