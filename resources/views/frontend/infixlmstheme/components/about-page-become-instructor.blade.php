...
<div>
    ...
    <div class="service_cta_area p-lg-5 p-3">
        <div class="container center-content-about mb-3 px-lg-5">
            {{-- <div class="border_top_1px"></div> --}}
            <div class="service_cta_row row px-xl-3 d-flex justify-content-center" id="service_cta_row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_cta_service d-flex flex-column align-items-center single_cta1">
                        <div class="thumb">
                            <!-- <img src="{{ asset(@$frontendContent->become_instructor_logo) }}" alt=""> -->
                            <img src="{{ asset('/public/uploads/images/footerimg/redlady.jpeg') }}">
                        </div>
                        <div class="cta_service_info text-center">
                ...
                <div class="col-lg-4 col-md-6 mt-3 mt-md-0">
                    <div class="single_cta_service d-flex flex-column align-items-center single_cta2">
                        <div class="thumb">
                            <!-- <img src="{{ asset(@$frontendContent->become_instructor_logo) }}" alt=""> -->
                            <img src="{{ asset('/public/uploads/images/footerimg/becometutorredlady.jpeg') }}">
                        </div>
                        <div class="cta_service_info text-center">
                            ...
                            <a href="{{ route('preRegistration') }}" class="theme_btn small_btn p-2">Share Knowledge</a>
                        </div>
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 mt-3 mt-lg-0">
                    <div class="single_cta_service d-flex flex-column align-items-center single_cta3">
                        <div class="thumb">
                            <!-- <img src="{{ asset(@$frontendContent->become_instructor_logo) }}" alt=""> -->
                            <img src="{{ asset('/public/uploads/images/footerimg/backtoschool.jpeg') }}">
                        </div>
                        <div class="cta_service_info text-center">
                            ...
                            <a href="{{ route('quizzes') }}" class="theme_btn small_btn p-2">Start New Career </a>
                        </div>
                    </div>
                </div>
            </div>
