            ...
            <div class="row px-md-5 px-1">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="quiz_test_wrapper">
                                <div class="quiz_test_header pb-0">
                                    @if ($course->type == 1)
                                    ...
                                    <div class="row w-100">
                                        <div class="col-lg-9 col-md-8 col-sm-7 mb-2 mb-sm-0 course_main_image">
                                            <div class="course_detail_image image_responsive px-md-2">
                                                <img src="{{ getCourseImage($course->image) }}" class="img-fluid w-100 img_round course_image h-100"
                    ...
                    <div class="row px-lg-5 small_screen course_padding">
                        <div class="col-lg-9 col-md-8 col-12">
                            <div class="course_tabs w-100 mb-3 px-md-2">
                                <ul class="w-100 nav lms_tabmenu" id="myTab" role="tablist">
                                    <li class="nav-item">
                                ...
                                <div class="tab-pane fade show active" id="Overview" role="tabpanel"
                                    ...
                                    <div class="course_overview_description">
                                        <div class="single_overview">
                                            <h4 class="font_22 f_w_700">{{ __('frontend.Instructions') }}</h4>
                                            
                                            <p class="mb_25"> {{ $course->quiz->instruction }} </p>
                                            @if (!empty($course->about))
                                            <h4 class="font_22 f_w_700">
                                                {{ __("$course_type Description") }}
                                            </h4>
                                            ...
                                            <h4 class="font_22 f_w_700">{{ __("$course_type Outcomes") }}
                                            </h4>
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-12 pb- py-sm-0">
                    <div class="sidebar__widget mb_30">
                        ...
                        @if (Auth::check())
                        <a href="{{ route('buyNowQuiz', [@$course->id]) . '?courseType=' . $request->courseType }}"
                            class="theme_line_btn d-block height_50 text-center">{{ __('common.Buy Now') }}</a>
                        @else
                        <a href="{{ route('buyNowQuiz', [@$course->id]) . '?courseType=' . $request->courseType }}"
                            class="theme_line_btn d-block height_50 text-center">{{ __('common.Buy Now') }}</a>
                        @endif
