                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div class="position-relative mt-4  @if ($errors->first('student_name')) is-invalid @endif">
                                <input type="text" class="outside form-control"name="student_name" id="student_name"
                        ...
                        <div class="form-group col-md-6">
                            <div class="position-relative mt-4 @if ($errors->first('declare_date')) is-invalid @endif">
                                <input type="date" class="outside"name="declare_date" id="declare_date" min="{{date('Y-m-d')}}"
