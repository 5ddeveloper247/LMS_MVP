    ...
    <div class="container px-xl-5">
        <div class="row my-4 my-lg-5 px-xl-5">
            ...
            <div class="col-lg-7">
                ...
                <h6 class="text-center mb-4 text-capitalize heading-reg">hello, welcome to Merkaii Xcellence <br>
                    <span class="font-weight-300">please fill the form below to get started</span>
                </h6>
                ...
                <form action="{{ route('register') }}" method="POST" id="regForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            <div class="position-relative mt-4 @if ($errors->first('phone')) is-invalid @endif">
                                <input type="number" name="phone" value="{{ $user->phone ?? old('phone') }}"
                                    class="outside" maxlength="14" minlength="10" required />
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="file" id="canvasFileInput" name="signature-img" style="display:none">
                    ...
                    <div class="text-center my-2">
                        <small>"By clicking 'Submit', you agree to Meraki International Societe's Terms of Use and <a href="{{url('customer-help#v-pills-profile-tab-1')}}">Privacy Policy</a>. You consent to receive phone calls and SMS messages from Meraki International Societe to provide updates and information in regards to your business with Meraki International Societe. Message frequency may vary. Message & data rates may apply. Reply STOP to opt-out of further messaging. Reply HELP for more information. See our <a href="{{url('customer-help#v-pills-profile-tab-1')}}">Privacy Policy</a>."</small>
                    </div>
            ...
            <div class="col-lg-5 px-0 d-none d-lg-block">
                ...
                <h6 class="text-uppercase my-3">Student-Centered | Expert Instructors | Empower |  Study Anywhere | Community</h6>
            </div>
        </div>
    </div>
