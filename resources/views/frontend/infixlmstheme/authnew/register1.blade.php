{{-- Profile step — same backend route/controller; new login-matching design shell --}}
@php
    $registerStep = 1;
    $registerStepTotal = 4;
    $registerStepTitle = 'Complete Your Profile';
    $registerStepSubtitle = 'Step 1 of 4 — tell us about yourself to continue registration.';
    $registerStepPartial = theme('authnew.partials.register-step-profile');
@endphp
