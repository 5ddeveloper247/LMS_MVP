    ...
    <div class="container custom-bg px-xl-5 my-md-5 my-3">
        <div class="row px-xl-5 px-md-2 preReg_row">
            <div class="col-lg-7 mb-2 mb-md-0">
                <div class="collapse @if (!count($errors)) show @endif" id="optionsCollapse">
              ...
              align-items: center;">MXP
                ...
                <div class="collapse @if (count($errors)) show @endif" id="mainContentCollapse">
