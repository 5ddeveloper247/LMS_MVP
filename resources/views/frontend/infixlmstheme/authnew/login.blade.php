...
@section('content')
    ...
    <div class="container custom-bg px-lg-5 my-md-5 my-3">
        <div class="row pt-2 px-lg-5 pb-5">
            <div class="col-lg-7">
                {{-- <div id="accountType">
              ...
              align-items: center;">MC
                ...
                <form action="{{ route('login') }}" method="POST" id="loginForm" class="hidemainContent">
                    ...
                    <span class="hidemainContent text-capitalize text-justify mt-3 ">By signing in you agree to Merkaii Xcellence college <span style="color: var(--system_primery_color);"><a
                            href="{{ route('customer-help') }}#v-pills-home-tab" style="color: var(--system_primery_color);">terms & conditions</a> |
                            <a href="{{ route('customer-help') }}#v-pills-profile-tab-1" style="color: var(--system_primery_color);">privacy policy</a></span></span>
