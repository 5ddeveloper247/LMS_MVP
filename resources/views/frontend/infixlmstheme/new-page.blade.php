    ...
    <div class="container-fluid px-0">
        ...
        <div class="container px-lg-5">
            <div class="row percent-row px-xl-5 px-3">
                ...
                {{-- <div data-aos="fade-left" class="col-lg-6 percent-video pr-2">
                    <!-- <img src="{{ asset('/public/assets/homesection5.png') }}" class="w-100 h-100"> -->
                    <img src="{{ asset('/public/uploads/images/footerimg/whoprogramisfor.png') }}" class="h-100 w-100">
                </div>
                <div class="col-lg-6 d-flex flex-column counter-padd px-md-0 py-lg-5 my-lg-5 mt-3">
                    <div data-aos="fade-right" class="d-flex justify-content-left align-items-center percent1 animatee">
                        ...
                        <div class="percent_content1">
                            <h5 class="percent-h custom_text_small">NCLEX Retesting</h5>
                            <p class="custom_paragraph percent-p">Graduates who have not passed the NCLEX after three
                                attempts will be able to use this remedial program to enhance their nursing knowledge, build
                                skills and gain confidence for a successful retake.</p>
                        </div>
                    </div>

                    <div data-aos="fade-right" data-aos-delay="100"
                        class="d-flex justify-content-left align-items-center percent2 animatee">
                        <h2 class="percent font-weight-bold">
                        ...
                        <div class="percent_content2">
                            <h5 class="percent-h custom_text_small">Support for Foreign Nurses</h5>
                            <p class="custom_paragraph percent-p">Our program helps foreign nurses meet Florida's licensure
                                requirements with targeted training and support.
                            </p>
                        </div>
                    </div>

                    <div data-aos="fade-right" data-aos-delay="200"
                        class="d-flex justify-content-left align-items-center percent3 animatee">
                        <h2 class="percent font-weight-bold">
                        ...
                        <div class="percent_content3">
                            <h5 class="percent-h custom_text_small">For Lapsed or Inactive Licenses</h5>
                            <p class="custom_paragraph percent-p">Nurses with inactive licenses or those who haven’t
                                practiced in five years can refresh their skills through our course.</p>
                        </div>
                    </div>

                    <div data-aos="fade-right" data-aos-delay="300"
                        class="d-flex justify-content-left align-items-center percent4 animatee">
                        <h2 class="percent font-weight-bold">
                        ...
                        <div class="percent_content4">
                            <h5 class="percent-h custom_text_small">NCLEX Remediation Preparation</h5>
                            <p class="custom_paragraph percent-p">For graduates preparing for the NCLEX-RN or NCLEX-PN
                                exams.</p>
                        </div>
                    </div>
                </div> --}}
            ...
            <div class="d-grid px-xl-5 px-3">
                <div>
                    <div data-aos="fade-right" class="d-flex justify-content-left align-items-center p-3"
                        style="background-color: #996699; height: 200px !important;">
                        <h2 class="percent font-weight-bold">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 340" width="50" height="40">
                                <g data-name="Layer 29">
                                    <path
                        ...
                        <div class="percent_content1 cus-h">
                            <h5 class="percent-h custom_text_small text-white">NCLEX Retesting</h5>
                            <p class="custom_paragraph percent-p text-white">Graduates who have not passed the NCLEX after
                                three
                                attempts will be able to use this remedial program to enhance their nursing knowledge,
                                build
                                skills and gain confidence for a successful retake.</p>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-right" data-aos-delay="100"
                        class="d-flex justify-content-left align-items-center p-3"
                        style="background-color: var(--teal); height: 200px !important;">
                        <h2 class="percent font-weight-bold">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 180" xml:space="preserve"
                                width="50" height="40">
                                <path fill="#FF916E"
                        ...
                        <div class="percent_content2 cus-h">
                            <h5 class="percent-h custom_text_small">Support for Foreign Nurses</h5>
                            <p class="custom_paragraph percent-p">Our program helps foreign nurses meet Florida's
                                licensure
                                requirements with targeted training and support.
                            </p>
                        </div>
                ...
                <div>
                    <img src="{{ asset('/public/uploads/images/footerimg/whoprogramisfor.png') }}"
                        style="height: 400px !important" class="w-100 object-fit-cover">
                </div>
                ...
                <div>
                    <div data-aos="fade-right" data-aos-delay="200"
                        ...
                        <div class="percent_content3 cus-h">
                            <h5 class="percent-h custom_text_small">For Lapsed or Inactive Licenses</h5>
                            <p class="custom_paragraph percent-p">Nurses with inactive licenses or those who haven’t
                                practiced in five years can refresh their skills through our course.</p>
                        </div>
                    ...
                    <div data-aos="fade-right" data-aos-delay="300"
                        ...
                        <div class="percent_content4 cus-h">
                            <h5 class="percent-h custom_text_small text-white">NCLEX Remediation Preparation</h5>
                            <p class="custom_paragraph percent-p text-white">For graduates preparing for the NCLEX-RN or
                                NCLEX-PN
                                exams.</p>
                        </div>
                    </div>
        ...
        <div class="container-fluid bg-full-nclex-card py-3 m-0 d-none d-md-block"
            ...
            <div class="container px-xl-5 pb-3 py-5 text-center">
                ...
                <h5>Process</h5>
                <h2 class="font-weight-bold custom_small_heading text-capitalize mt-3">How it woks</h2>
                ...
                <div class="work_flow d-flex align-items-center justify-content-center py-5 px-4">
                    ...
                    <div class="position-relative p-5 d-flex align-items-center justify-content-center text-center"
                        ...
                        <h6>Activate Your Microsoft Account</h6>
                    </div>
