                    ...
                    <div class="row px-lg-5 small_screen">
                        ...
                        <div class="d-flex flex-column justify-content-between">
                            <div class="amount_total">
                                ...
                                ${{ $program_detail->effectiveProgramPlan[0]->amount }}
                            </h4>
                            
                            @if (!empty($program_detail->effectiveProgramPlan[0]->initialProgramPalnDetail[0]))
                            <small class="program-span"
                            style="font-size: 15px;">Initial:${{ $program_detail->effectiveProgramPlan[0]->initialProgramPalnDetail[0]->amount }}</small>
                            @endif
                            @endif
                        </div>
                    ...
                    <div class="custom_section_color rounded_section p-2" style="height: auto;">
                        ...
                        @if (isset($program_detail->effectiveProgramPlan[0]))
                            <span class="program-span"><i class="fa-clock-o fas"></i>&nbsp;&nbsp; Duration |
                                {{ round((strtotime($program_detail->effectiveProgramPlan[0]->edate) - strtotime($program_detail->effectiveProgramPlan[0]->sdate)) / 604800, 1) }}
                                Weeks
                            </span>
                            <br class="mt-2">
                        ...
                        <div class="row mx-0 mt-2">
                            @forelse($recent_program as  $program)
                                ...
                                <div class="col-xl-7 col-lg-7 col-md-6 col-8 p-0">
                                    ...
                                    @if(isset($program->effectiveProgramPlan[0]))
                                    <p> {{ round((strtotime($program->effectiveProgramPlan[0]->edate) - strtotime($program->effectiveProgramPlan[0]->sdate)) / 604800, 1) }}
                                        Weeks</p>
                                        <p class="color"> ${{ $program->effectiveProgramPlan[0]->amount }}</p>
                                    @endif
                        ...
                        <div class="tab-pane fade show active" id="Overview" role="tabpanel"
                            ...
                            <div class="desc">
                                @if ($program_detail->discription)
                                    ...
                                    <div class="row">
                                    	<div class="col-12">
                                         	<div class="table-responsive ck ckdtext ck-content clearfix" style="overflow:hidden;">
                                                    ...
                                                    <h6 style=" color: var(--system_secendory_color);" class="mb-0">
                                                        <span style="font-size: 22px;font-weight:bold;">
                                                            ...
                                                            @if (isset($program_detail->currentProgramPlan[0]) && $programPlans->id == $program_detail->currentProgramPlan[0]->id)
                                                                (Current)
                                                            @elseif(\Carbon\Carbon::parse($programPlans->edate) < \Carbon\Carbon::now())
                                                                (Closed)
                                                            @else
                                                                (Pending)
                                                            @endif
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="">
                                                                    ...
                                                                    <div style="float: right">
                                                                        @if (\Carbon\Carbon::parse($programPlans->cdate) > \Carbon\Carbon::now())
                                                                            @if (Auth::check())
                    ...
                    <div class="custom_section_color rounded_section mb-1 p-2">
                        ...
                        <p class="my-1 program-span"><i class="fa fa-calendar-days"></i>&nbsp;&nbsp; Current Cohort End :
                            ...
                            <span class="font-weight-bold">
                                    {{ \Carbon\Carbon::parse($program_detail->effectiveProgramPlan[0]->edate)->format('d M Y') }}</span>
                                {{-- <br class="mt-2"> --}}
                        ...
                        <p class="my-1 program-span"><i class="fa fa-calendar-days"></i>&nbsp;&nbsp; Current Cohort Class :
                            @if (isset($program_detail->effectiveProgramPlan[0]))
                            
                            <span class="font-weight-bold">
                                    {{ \Carbon\Carbon::parse($program_detail->effectiveProgramPlan[0]->cdate)->format('d M Y') }}</span>
                                {{-- <br class="mt-2"> --}}
                        ...
                        <p class="my-1 program-span"><i class="fa fa-calendar-days"></i>&nbsp;&nbsp; Next Cohort Start :
                            @if (isset($program_detail->effectiveProgramPlan[1]))
                                {{-- <br class="mt-2"> --}}
                                <span
                                    class="font-weight-bold">{{ \Carbon\Carbon::parse($program_detail->effectiveProgramPlan[1]->sdate)->format('d M Y') }}</span>
                            @else
                                <span class="font-weight-bold">Not Given</span>
                            @endif
                        </p>
                        @if (isset($program_detail->effectiveProgramPlan[0]))
                            <div class="row mt-3 text-center">
                                @if (!Auth::user())
                                    <div class="col-12">
                                        <a href="{{ route('buyNow', ['id' => $program_detail->id, 'plan_id' => $program_detail->effectiveProgramPlan[0]->id]) }}" class="theme_btn small_btn4 px-2 pt-1 pb-2">Apply
                                            Now</a>
                                    </div>
                                @endif
