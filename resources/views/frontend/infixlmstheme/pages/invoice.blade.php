        ...
        <div class="row py-4">
            ...
            <div class="col-3">
                <div class="main-title d-flex h-100 justify-content-center align-items-center">
                            <h3 class="text-uppercase mb-0">INV-{{ str_pad($enroll->id,5,"0",STR_PAD_LEFT) }}</h3>
                        </div>
            </div>
        </div>
    {{-- </div> --}}
...
{{-- <div class="container"> --}}
    <div class="row">
        <table class="table">
            <tr>
                <td>Invoice Date & Time:<br><u>{{ date('d F Y H:i a',strtotime($enroll->created_at)) }}</u></td>
        ...
        <tbody>
                        ...
                        @if (!empty($tutorHiring))
                            <tr>
                                ...
                                <td class="black_color">
                                    ...
                                    @php $total = $total + $tutorHiring->price @endphp
                                </td>
                            </tr>
                        @endif
                    @endforeach
            ...
            @elseif ($enroll->type == 'package')
                <tr>
                    ...
                    <td colspan="2">
                        <h5 class="black_color">Package Purchasing<br>
                            <small><b>Package Name:</b> {{($purchasing && $purchasing->package) ? $purchasing->package->title : '--Deleted Package--'}}</small>
                        </h5>
                    </td>
                    <td class="black_color">
                        {{ $enroll->price }}
            ...
            @elseif($enroll->type == 'plan_installment_pay')
                <tr>
                    ...
                    <td class="black_color">
                        ...
                        @php $total = $total + $enroll->studentIstallment->amount @endphp
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="black_color">
                        @if ($enroll->price)
                            ...
                            @php $total = $total + $enroll->price @endphp
                        @else
                            100
                            @php $total = $total + 100 @endphp
                        @endif
