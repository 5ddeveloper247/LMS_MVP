...
<div class="container px-lg-5 teach_offer">
    ...
    <div class="row py-md-5 px-xl-5 py-4 px-3">
        <div class="col-md-12 text-center">
            <h2 class="font-weight-bold custom_heading_1 mb-md-4 mb-3 text-capitalize"> What We Offer You to Shape
        ...
        <div class="col-md-6 col-12 my-auto px-lg-1 teach_offer2" data-aos="fade-left" data-aos-delay="500">
            <div class="px-xl-3 custom_height_2">
                ...
                <p class="mb-2 text-justify">
                    <span class="font-weight-bold">Be Your Own Curriculum Boss: </span> and publish the course you envision,
                    using your preferred teaching methods and content. You have complete control over the material you deliver.
                    <br>
                    <span class="font-weight-bold">Share Your Passion, Amplify Your Impact:</span> Our platform empowers you to
                    teach the subjects you're most passionate about. Share your knowledge and inspire the next generation of healthcare professionals.
                    <br>
                    <span class="font-weight-bold">Build a Thriving Community:</span> Collaborate and share knowledge with a
                    network of passionate educators and eager learners.
                    <br>
                    <span class="font-weight-bold">Monetize Your Expertise:</span> Sharpen your skills by developing and delivering
                    courses. You earn directly for each student you enroll, creating a rewarding financial return.
                    <br>
                    <span class="font-weight-bold">Freedom and Flexibility:</span> Design your course schedule and tailor your
                ...
                <div class="section__title teach_section">
                    ...
                    <div class="d-flex mt-3" style="gap: 10px">
                        ...
                        <div class="d-flex flex-column px-md-2 px-xl-4">
                            ...
                            <!-- First paragraph with SVG icon -->
                            <div class="d-flex align-items-start mb-2">
                                <div class="svg-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 64 64">
                                        <path fill="#ff7619" d="M56.734 5.081c-8.437 7.302-15.575 14.253-22.11 23.322c-2.882 4-6.087 8.708-8.182 13.153c-1.196 2.357-3.352 6.04-4.087 9.581c-4.02-3.74-8.338-7.985-12.756-11.31c-3.149-2.369-12.219 2.461-8.527 5.239c6.617 4.977 12.12 11.176 18.556 16.375c2.692 2.172 8.658-2.545 10.06-4.524c4.602-6.52 5.231-14.49 8.585-21.602c5.121-10.877 14.203-19.812 23.17-27.571c5.941-5.541-.195-6.563-4.7-2.663" />
                                    </svg>
                                </div>
                                <p class="mb-0 pl-2">Create custom coupons to incentivize students.</p>
                            </div>

                            <!-- Second paragraph with SVG icon -->
                            <div class="d-flex align-items-start mb-2">
                                <div class="svg-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 64 64">
                                        <path fill="#ff7619" d="M56.734 5.081c-8.437 7.302-15.575 14.253-22.11 23.322c-2.882 4-6.087 8.708-8.182 13.153c-1.196 2.357-3.352 6.04-4.087 9.581c-4.02-3.74-8.338-7.985-12.756-11.31c-3.149-2.369-12.219 2.461-8.527 5.239c6.617 4.977 12.12 11.176 18.556 16.375c2.692 2.172 8.658-2.545 10.06-4.524c4.602-6.52 5.231-14.49 8.585-21.602c5.121-10.877 14.203-19.812 23.17-27.571c5.941-5.541-.195-6.563-4.7-2.663" />
                                ...
                                <p class="mb-0 pl-2">Leverage our global promotional channels to drive traffic to your courses.</p>
                            </div>

                            <!-- Third paragraph with SVG icon -->
                            <div class="d-flex align-items-start mb-2">
                                <div class="svg-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 64 64">
                                        <path fill="#ff7619" d="M56.734 5.081c-8.437 7.302-15.575 14.253-22.11 23.322c-2.882 4-6.087 8.708-8.182 13.153c-1.196 2.357-3.352 6.04-4.087 9.581c-4.02-3.74-8.338-7.985-12.756-11.31c-3.149-2.369-12.219 2.461-8.527 5.239c6.617 4.977 12.12 11.176 18.556 16.375c2.692 2.172 8.658-2.545 10.06-4.524c4.602-6.52 5.231-14.49 8.585-21.602c5.121-10.877 14.203-19.812 23.17-27.571c5.941-5.541-.195-6.563-4.7-2.663" />
                                ...
                                <p class="mb-0 pl-2">Gain additional exposure through our Merkaii Gold Plan (if applicable).</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card custom_card_plan shadow">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="">
                        ...
                        <div class="d-flex align-items-start gap_10 feature">
