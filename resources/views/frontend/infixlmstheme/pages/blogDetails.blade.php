...
@section('mainContent')
    ...
    <div class="container">
        <div class="row py-md-5 py-4 g-0">
            <div class="col-12 col-md-8 pr-0 mb-3">
                <div class="card rounded-3 pt-lg-5 pt-4 pb-4 px-lg-5 px-4 ml-xl-5 mr-lg-4 mr-3" style="border-radius: 15px;">
                    <img src="{{ getBlogImage($blog->image) }}" class="img-fluid rounded-3 custom-img-blog" alt=""
                    ...
                    <div class="d-flex align-items-center py-3 gap-2">
                        ...
                        <span class="text-dark">{{ date('F, d',strtotime($blog->authored_date)) }}</span>

                    </div>
                    <div class="card-text">
                        <h2 class="custom_small_heading fw-bold opacity-75">
                            {{ $blog->title }}
                        </h2>
            ...
            <div class="col-12 col-md-4 pr-0 pr-lg-4">
                <div class="search mr-xl-5 mr-lg-4 mr-3">
                    ...
                    <form class="search-input-field rounded-3 p-lg-5 p-3" action="{{ route('blogs') }}" style="margin:auto;">
