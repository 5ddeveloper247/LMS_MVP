...
@section('mainContent')
    ...
    <section id="apply" class="p-lg-5 p-3 pt-4">
        <div class="container-fluid">
            <div class="row justify-content-center text-center px-xl-4 px-md-3 hidden-left">
                <div class="col-md-9 our_require_section px-xl-5 px-3 mx-md-5 text-md-start text-center mb-4">
                    ...
                    <p> Our academic review courses, live lectures, and supportive
                        community are designed to help students reach their full potential.</p>
                    <p>
                    ...
                    <br>
                    <p>
                        This page outlines the application requirements for prospective students.
                    </p>
                    <P> Please
    ...
    <div class="our-process-section-container slider-bg mt-3">
        <div class="our-process-section-wrapper px-sm-3 px-2 py-lg-5 py-3">
            <h2 class="custom_small_heading heading mb-3 font-weight-bold text-center">Embark on Your Healthcare Education
                Journey</h2>
                ...
                <div class="our-process-section-part d-flex gap-5 w-50" data-aos="fade-right" data-aos-duration="1000">
                    <div class="padding-top-of-first-part ml_our_process">
                        ...
                        <div class="d-flex align-items-center gap-sm-3 pb-3 small_gap">
                            <p class="fw-light text-md-end mt-2 mt-md-0">Sign up for a free Merkaii Xcellence Prep account
                                to explore
            ...
            <div class="">
                <div class="our-process-section-part d-flex gap-5 w-50" data-aos="fade-right" data-aos-duration="1000">
                    <div class="d-flex flex-column align-items-end ml_our_process">
                        ...
                        <h5 class="w-100 text-md-end brdr-btm-of-txt fw-medium pb-3 mb-5 mb-md-0">Find your Perfect Course
                        </h5>
                        <div class="d-flex align-items-center gap-sm-3 pb-3 small_gap">
...
<div class="col-lg-3 col-md-6 col-sm-12 p-3 d-flex">
    ...
    <div class="featured-carousel owl-carousel m-md-0 app_require mb-3">
        ...
        @foreach ($slider as $slide)
            <div class="d-flex h-100 embeded-text-overflow">
                <div class="col-sm-6 py-3 small_screen_carousel d-flex flex-column justify-content-center"
                    style="background-color:{{ $slide->color }}">
                    <div class="pt-sm-4 mx-md-5 mx-3">
                        <h5 class="slider_heading_h1 font-weight-bold px-0 px-lg-5 px-sm-3 text-white">
                            {{ $slide->title }}
                        </h5>
                        <p class="px-0 px-lg-5 px-sm-3 slider_paragraph text-white cont1domgdo_para">
                            {{ $slide->text }}
                        </p>
                        @if ($slide->btn_title != '')
                            @if ($slide->btn_link != '')
                                <a href="{{ $slide->btn_link }}" class="px-0 px-lg-5 px-sm-3">
                            @endif
                            <button class="theme_btn mt-3 {{ $slide->btn_class }}">{{ $slide->btn_title }}</button>
    ...
    <div class="row justify-content-center py-lg-5 py-4">
        <div class="col-12 col-md-7 text-center text-lg-left">
            <h2 class="custom_small_heading heading font-weight-bold text-capitalize text-center mb-0 px-4 px-md-0">Required
                Application Documents for FL Approved Remedial Program</h2>
        </div>
        <div class="col-md-7 col-10 mt-3">
            <div class="boxaccordion mt-2">
                <div class="containerwidth">
                    ...
                    <div class="wrapper">
                        <button class="toggle">Signed Enrollment Acknowledgement Declaration form<i
                    ...
                    <div class="wrapper">
                        <button class="toggle">Copy of Driver’s License / SS# Card<i
                                class="fas fa-plus icon"></i></button>
                        <div class="content">
                    ...
                    <div class="wrapper">
                        <button class="toggle">Current Physical Exam (less than 1-Year)<i
                                class="fas fa-plus icon"></i></button>
                        <div class="content">
                            <p>Professional Trade License for Entrance in BSN program.</p>
                        </div>
                    ...
                    <div class="wrapper">
                        <button class="toggle">Proof of Vaccinations – MMR (Titer), Tetanus, Tdap, Varicella<i
                                class="fas fa-plus icon"></i></button>
                        <div class="content">
                            <p>Professional Trade License for Entrance in BSN program.</p>
                        </div>
                    ...
                    <div class="wrapper">
                        <button class="toggle">Proof of Hepatitis B or Decline Waiver Form<i
                                class="fas fa-plus icon"></i></button>
                        <div class="content">
                            <p>Professional Trade License for Entrance in BSN program.</p>
                        </div>
                    ...
                    <div class="wrapper mb-lg-5 mb-3">
                        <button class="toggle">Proof of Health Insurance for Clinical<i
                                class="fas fa-plus icon"></i></button>
                        <div class="content">
                            <p>Professional Trade License for Entrance in BSN program.</p>
                        </div>
                    ...
                    @foreach ($faqs as $thisfaq)
                        <div class="wrapper">
                            <button class="toggle">{{ $thisfaq->question }}<i class="fas fa-plus icon"></i></button>
                            <div class="content">
    ...
    <div class="container-fluid p-0" style="background-color: #eee;">
        <div class="row mb-md-5 mb-4 justify-content-center px-4 px-sm-5 px-md-0">
            <div class="col-md-9 py-lg-5 px-lg-5 py-3">
                <div class="custom_fs_a d-flex flex-column justify-content-center align-items-center mx-lg-0 px-sm-4 px-md-0"
                    style="gap: 10px;">
                    <h2 class="custom_small_heading text-center font-weight-bold avail-ser mb-0">FOCUSED LEARNING +
                        DISCIPLINE + CONSISTENCY = GOALS ACHIEVED
                    </h2>
...
@section('js')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            gsap.from(".hidden-left", {
                scrollTrigger: {
                    trigger: ".hidden-left", // Start the animation when this section comes into view
                    start: "top 75%", // Start when the section is 75% from the top of the viewport
                    toggleActions: "play none none reverse" // Play the animation on scroll, reverse when scrolling back
                },
            ...
            // Animate the heading
            gsap.from(".our_require_section h2", {
                scrollTrigger: {
                    trigger: ".hidden-left",
                    start: "top 75%",
            ...
            gsap.from(".our_require_section p", {
                scrollTrigger: {
                    trigger: ".hidden-left",
                    start: "top 75%",
                    toggleActions: "play none none reverse"
                ...
                duration: 1.5,
                stagger: 0.3 // Add a slight delay between each paragraph's animation
            });

            // Animate the "Apply Now" button if it exists
            gsap.from(".contact_btn", {
                ...
                opacity: 0,
                scale: 0.8, // Scale up from 80% to 100%
                duration: 1,
                delay: 1 // Delay the button animation slightly so it starts after the paragraphs
            });
        });
    </script>
