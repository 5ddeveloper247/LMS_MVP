...
<style>
    ...
    header .contianer-fluid,
    footer .contianer-fluid {
...
@section('mainContent')
    <div class="container-fluid">
            ...
            <div class="container px-lg-5 py-5">
                <div class="row justify-content-between py-5 px-xl-5 px-3">
                    <div data-aos="fade-left" class="col-md-6">
                        ...
                        <ul class="mt-3">
                            <li class="mb-4">
                                <img src="https://cdn-icons-png.flaticon.com/128/10096/10096560.png" width="25"
                                    alt="">
            ...
            <div class="container px-lg-5 py-5">
                <div class="row py-5 px-xl-5 px-3">
                    <div class="text-center">
                        ...
                        <p class="text-muted inter mb-5">
                            Everything you need to succeed and pass NCLEX
                        </p>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card get_card border-0 h-100 px-3 py-5 d-flex align-items-center justify-content-center"
                            ...
                            <h4 class="text-dark mt-3 inter">Personalized Coaching</h4>
                            <p class="text-dark">1-on-1 weekly mentor calls</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card get_card border-0 h-100 px-3 py-5 d-flex align-items-center justify-content-center"
                            ...
                            <h4 class="text-white mt-3 inter">Clinical Skills Review</h4>
                            <p class="text-white">Simulation + Concept Review</p>
                        </div>
                    </div>
        ...
        <img src="{{ asset('public/assets/timeline.png') }}" width="100%" alt="Reviewer">
                    ...
                    @if (isset($recent_program[0]))
                        <div data-aos="fade-right" class="row justify-content-left align-items-center p-3"
                            ...
                            <div class="col-10 percent_content1 cus-h">
                                <h5 class="percent-h custom_text_small text-white">
                                    {{ $recent_program[0]['programtitle'] }}</h5>
                                ...
                                <div class="d-flex gap-2 flex-column">
                                    <p class="custom_paragraph percent-p text-white">
                                        <b>Duration:</b>
                                        {{ $recent_program[0]['effective_program_plan'][0]['sdate'] }} to
                                        {{ $recent_program[0]['effective_program_plan'][0]['edate'] }}
                                        <br>
                                        <b>Price:</b>
                            ...
                            <div class="col-12 text-center mb-auto">
                                ...
                                <a href="{{ route('programs.detail', $recent_program[0]['id']) }}"
                                    class="theme_btn small_btn text-center responsive-style-btn ">Apply Now</a>
                            </div>
                        </div>
                    @endif
                    @if (isset($recent_program[2]))
                        <div data-aos="fade-right" data-aos-delay="100"
                            ...
                            <div class="col-10 percent_content2 cus-h">
                                <h5 class="percent-h custom_text_small text-white">
                                    {{ $recent_program[2]['programtitle'] }}</h5>
                                <p class="custom_paragraph percent-p text-white">{{ $recent_program[2]['subtitle'] }}</p>
                                <div class="d-flex gap-2 flex-column">
                                    <p class="custom_paragraph percent-p text-white">
                                        <b>Duration:</b>
                                        {{ $recent_program[2]['effective_program_plan'][0]['sdate'] }} to
                                        {{ $recent_program[2]['effective_program_plan'][0]['edate'] }}
                                        <br>
                                        <b>Price:</b>
                            ...
                            <div class="col-12 text-center mb-auto">
                                ...
                                <a href="{{ route('programs.detail', $recent_program[2]['id']) }}"
                                    class="theme_btn small_btn text-center responsive-style-btn ">Apply Now</a>
                            </div>
                        </div>
                    @endif
                    ...
                    @if (isset($recent_program[1]))
                        <div data-aos="fade-right" data-aos-delay="200"
                            ...
                            <div class="col-10 percent_content3 cus-h">
                                <h5 class="percent-h custom_text_small text-white">
                                    {{ $recent_program[1]['programtitle'] }}</h5>
                                <p class="custom_paragraph percent-p text-white">{{ $recent_program[1]['subtitle'] }}</p>
                                <div class="d-flex gap-2 flex-column">
                                    <p class="custom_paragraph percent-p text-white">
                                        <b>Duration:</b>
                                        {{ $recent_program[1]['effective_program_plan'][0]['sdate'] }} to
                                        {{ $recent_program[1]['effective_program_plan'][0]['edate'] }}
                                        <br>
                                        <b>Price:</b>
                            ...
                            <div class="col-12 text-center mb-auto">
                                ...
                                <a href="{{ route('programs.detail', $recent_program[1]['id']) }}"
                                    class="theme_btn small_btn text-center responsive-style-btn ">Apply Now</a>
                            </div>
                        </div>
                    @endif
                    @if (isset($recent_program[3]))
                        <div data-aos="fade-right" data-aos-delay="300"
                            ...
                            <div class="col-10 percent_content4 cus-h">
                                <h5 class="percent-h custom_text_small text-white">
                                    {{ $recent_program[3]['programtitle'] }}</h5>
                                <p class="custom_paragraph percent-p text-white">{{ $recent_program[3]['subtitle'] }}</p>
                                <div class="d-flex gap-2 flex-column">
                                    <p class="custom_paragraph percent-p text-white">
                                        <b>Duration:</b>
                                        {{ $recent_program[3]['effective_program_plan'][0]['sdate'] }} to
                                        {{ $recent_program[3]['effective_program_plan'][0]['edate'] }}
                                        <br>
                                        <b>Price:</b>
                            ...
                            <div class="col-12 text-center mb-auto">
                                ...
                                <a href="{{ route('programs.detail', $recent_program[3]['id']) }}"
                                    class="theme_btn small_btn text-center responsive-style-btn ">Apply Now</a>
                            </div>
                        </div>
                    @endif
