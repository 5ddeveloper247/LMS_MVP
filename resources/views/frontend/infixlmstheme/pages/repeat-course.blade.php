...
<style>
    ...
    * {
    ...
    .carousel-overlay {
        ...
        z-index: 1;
        /* Ensure overlay appears above the image */
    }
...
.repeat-course-cards {
    ...
    height: 100%; /* Ensures the card stretches to fill available space */
}

/* Flex-grow for card body content */
.repeat-course-cards .card-body {
    display: flex;
    flex-direction: column;
    flex-grow: 1;
}

/* Style the headings to maintain the original overflow and ellipsis behavior */
.repeat-course-cards h5 {
    display: -webkit-box;
    -webkit-line-clamp: 2;
...
/* Limit the height of the paragraph, but allow flexbox to ensure equal card heights */
.repeat-course-cards p {
    display: -webkit-box;
    -webkit-line-clamp: 8;
    -webkit-box-orient: vertical;
    overflow: hidden;
    ...
    <div class="container py-5 px-md-5 text-center">
        <div class="row mx-md-5">
            <div class="col-lg-3 col-md-6 col-sm-12 p-2">
                <div class="card rounded-card repeat-course-cards" data-aos="fade-up" data-aos-delay="500">
                    <div class="card-body">
                        <h5 class="py-1">{{ $course->course_sale_data->card_1_heading ?? '' }}</h5>
                        <h6>{{ $course->course_sale_data->card_1_subheading ?? '' }}</h6>
                        <p>{{ $course->course_sale_data->card_1_text ?? '' }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 p-2">
                <div class="card rounded-card repeat-course-cards" data-aos="fade-up" data-aos-delay="700">
                    <div class="card-body">
                        <h5 class="py-1">{{ $course->course_sale_data->card_2_heading ?? '' }}</h5>
                        <h6>{{ $course->course_sale_data->card_2_subheading ?? '' }}</h6>
                        <p>{{ $course->course_sale_data->card_2_text ?? '' }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 p-2">
                <div class="card rounded-card repeat-course-cards" data-aos="fade-up" data-aos-delay="900">
                    <div class="card-body">
                        <h5 class="py-1">{{ $course->course_sale_data->card_3_heading ?? '' }}</h5>
                        <h6>{{ $course->course_sale_data->card_3_subheading ?? '' }}</h6>
                        <p>{{ $course->course_sale_data->card_3_text ?? '' }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 p-2">
                <div class="card rounded-card repeat-course-cards" data-aos="fade-up" data-aos-delay="1100">
                    <div class="card-body">
                        <h5 class="py-1">{{ $course->course_sale_data->card_4_heading ?? '' }}</h5>
                        <h6>{{ $course->course_sale_data->card_4_subheading ?? '' }}</h6>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="carousel-background">
                    <img src="{{ getCourseImage($course->course_sale_data->slider_1_image) ?? '' }}" class="d-block w-100" alt="Slide 1">
                    <div class="carousel-overlay"></div>
                </div>
                <div class="carousel-caption d-flex flex-column justify-content-center align-items-center h-100">
                    <h2 class="carousel_text_heading">
                        {{ $course->course_sale_data->slider_1_heading ?? '' }}
                    </h2>
                    <p class="carousel_text_paragraph">
            ...
            <div class="carousel-item">
                <div class="carousel-background">
                    <img src="{{ getCourseImage($course->course_sale_data->slider_2_image) ?? '' }}" class="d-block w-100" alt="Slide 2">
                    <div class="carousel-overlay"></div>
                </div>
                <div class="carousel-caption d-flex flex-column justify-content-center align-items-center h-100">
                    <h2 class="carousel_text_heading">
            ...
            <div class="carousel-item">
                <div class="carousel-background">
                    <img src="{{ getCourseImage($course->course_sale_data->slider_3_image) ?? '' }}" class="d-block w-100" alt="Slide 3">
                    <div class="carousel-overlay"></div>
                </div>
                <div class="carousel-caption d-flex flex-column justify-content-center align-items-center h-100">
                    <h2 class="carousel_text_heading">
    ...
    <div class="row py-5">
        <div class="col-lg-6 col-md-6 col-sm-12 col-12 cont1doimgdo px-md-4 py-xl-5 py-md-4 py-3">
            ...
            <div class="col-md-12 mx-xl-5 mx-3 mt-4 px-5">
                ...
                <a href=" {{ route('buyNowQuiz', [$course->parent->id]) . '?courseType=' . $course->type }}"
                    class="theme_btn small_btn2 p-2">{{ __('common.Buy Now') }}</a>
                @endif
                @else
                <a href="javascript:void(0)" class="theme_btn small_btn2 p-2">{{ __('Completed') }}</a>
                @endif
...
<script>
    ...
    function startSlide() {
        theInterval = setInterval(changeSlide, 000);
    }
