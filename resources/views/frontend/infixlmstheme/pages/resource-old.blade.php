...
@section('mainContent')
    ...
    <div class="container-fluid">
        ...
        <div class="container pt-md-5 pt-4 px-lg-5">
            <!-- <div class="col-xl-9 col-lg-9 col-md-8 mt-3 px-2"> -->
           
          
            <!-- 3rdstart -->
            <div class="row small_screen mt-4 mb-2 mb-md-4 px-4">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-12">
                    <div class="custom_section_color rounded_section pt-2 px-2 program_tab mb-3">
                        <h5 class="custom_small_heading font-weight-bold custom_heading_1">Explore</h5>
                        <div class="row mx-0 mt-2">
                            @forelse($recent_program as  $program)
                                ...
                                <div class="col-xl-7 col-lg-7 col-md-6 col-8 p-0">
                                    ...
                                    <p> {{ round((strtotime($program->effectiveProgramPlan[0]->edate) - strtotime($program->currentProgramPlan[0]->sdate)) / 604800, 1) }}
                                        Weeks</p>
                        ...
                        <div class="row mx-0 mt-2">
                            @forelse($recent_courses as  $courses)
                            @php
                                $slug = $courses->parent ? $courses->parent->slug : $courses->slug;
                            @endphp
                                <div class="col-xl-5 col-lg-5 col-md-6 col-4 cus-mb-5 pl-0 pr-2">
                                    <a href="{{ route('courseDetailsView',['slug' => $slug, 'courseType' => $courses->type])}}">
                                        <img style="object-fit: cover;" src="{{ getCourseImage($courses->thumbnail) }}"
                                             class="img-fluid img_height">
                                    </a>
                                </div>
                                <div class="col-xl-7 col-lg-7 col-md-6 col-8 p-0">
                                    <p class="p-clamp program-span">
                                        <a class="text-dark" href="{{ route('courseDetailsView',['slug' => $slug, 'courseType' => $courses->type]) }}">
                                            {{ $courses->parent ? $courses->parent->title : $courses->title }}</a>
                                    </p>
                                        
                                    @if(isset($courses->effectiveCoursePlan[0]))
                                    <p> {{ round((strtotime($courses->effectiveCoursePlan[0]->edate) - strtotime($program->currentProgramPlan[0]->sdate)) / 604800, 1) }}
                                        Weeks</p>
                                    <p class="color"> ${{ $courses->effectiveCoursePlan[0]->amount }}</p>
                                    @else
                                    <p class="color"> ${{ $courses->price }}</p>
