                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="progress_percent flex-fill text-right">
                                                            @php
                                                                $date_now = \Carbon\Carbon::now()->setTimezone(Settings('active_time_zone'))->format('H:i:s');
                                                                // dd($tutor,\Carbon\Carbon::parse($tutor->assign_start_time),\Carbon\Carbon::now()->setTimezone(Settings('active_time_zone')));
