...
Route::group(['namespace' => 'Frontend'], function () {
    ...
    Route::get('florida-remedial-program', 'ProgramController@floridaPrograms')->name('floridaPrograms');
...
Route::group(['namespace' => 'Frontend', 'middleware' => ['student']], function () {
    ...
    Route::post('my-program-payment-plan/requestChange', 'StudentController@paymentPlanChangeRequest')->name('myProgramPaymentPlan.requestChange');
...
Route::group(['namespace' => 'Admin', 'prefix' => 'communication', 'as' => 'communication.', 'middleware' => ['auth']], function () {
...
// Route::get('florida-remedial-program',function(){
