...
//sliders
    ...
    Route::post('/sliders/setting2', 'SliderController@settingSubmit2')->name('sliders.setting2');
    Route::post('/sliders/setting-florida', 'SliderController@settingSubmitFlorida')->name('sliders.settingFlorida');
    Route::post('/sliders/setting3', 'SliderController@settingSubmit3')->name('sliders.setting3');
    Route::post('/sliders/setting4', 'SliderController@settingSubmit4')->name('sliders.setting4');
    Route::post('/sliders/setting5', 'SliderController@settingSubmit5')->name('sliders.setting5');
    Route::post('/sliders/setting6', 'SliderController@settingSubmit6')->name('sliders.setting6');
...
//how_programs_work_tiles
    Route::resource('/how_programs_work', 'HowProgramsWorkController')->except('show', 'update', 'destroy');
    Route::post('/how_programs_work/update', 'HowProgramsWorkController@update')->name('how_programs_work.update');
    Route::get('/how_programs_work/destroy/{id}', 'HowProgramsWorkController@destroy')->name('how_programs_work.destroy');
    Route::post('/how_programs_work/setting', 'HowProgramsWorkController@settingSubmit')->name('how_programs_work.settingSubmit');
