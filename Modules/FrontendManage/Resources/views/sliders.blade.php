                                        ...
                                        <div class="row">
                                            ...
                                            @if(!isModuleActive('Org'))
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('common.Sub Title') }} <small>(Max Length: 300)</small></label>
                                                        <input name="sub_title" id="sub_title"
                                                               class="primary_input_field name {{ @$errors->has('sub_title') ? ' is-invalid' : '' }}" maxlength="300"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label"
                                                        ...
                                                        <small>({{__('common.Recommended Size')}} 1600x750)</small>
                                                    </label>
