            ...
            <div class="modal-content">
                <form method="POST" id="status_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="primary_input mb-25 d-none" id="commentDiv">
                                    <label class="primary_input_label" for="">{{ __('Reason for Decline') }}
                                    </label>
                                        <textarea name="decline_comment" id="decline_comment" class="primary_input_field" cols="30" rows="10"></textarea>
                                </div>
