                    ...
                    <div class="col-lg-12">
                        <div class="white_box mb_30">
                            ...
                            <form action="{{ route('tutorRevenue') }}" method="POST" class="form row" id="withdraw_form">
                                ...
                                <input type="hidden" name="revenue" id="revenue" value="{{ $balance }}">
                                <div class="col-md-5 my-auto">
                                    <h5>Your Total Revenue is {{ $total_tutor_revenue == 0 ? $total_tutor_revenue : getPriceFormat($total_tutor_revenue) }}</h5>
                                    {{-- <h5>Your Current Balance is {{ $balance == 0 ? $balance : getPriceFormat($balance) }}</h5> --}}
                                </div>
        ...
        $(document).ready(function() {
            $('#withdraw_btn').on('click', function() {
                ...
                if (amount == '') {
                    ...
                    return false;
                } else if (parseFloat(amount) > parseFloat(revenue)) {
