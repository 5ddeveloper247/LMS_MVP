                                                                            ...
                                                                            <td id="status-col">
                                                                                @if(isset($studentauthorziationagreement->status))
                                                                                    @switch($studentauthorziationagreement->status)
                                                                                        ...
                                                                                        @if($studentauthorziationagreement->comment)
                                                                                        <p>Comment:</p>
                                                                                        <small> <i>{{ $studentauthorziationagreement->comment }}</i> </small>
                                                                                        @endif
                                                                                        @break
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" id="change_status_form">
                            ...
                            <div class="primary_input mb-15 d-none" id="statusCommentDiv">
                                <label class="primary_input_label"
                                    for=" ">{{__('Comment')}}</label>
...
@push('scripts')
    ...
    <script>
        function changeStudentStatus(student_id, status) {
            ...
            if(status==2){
                $('#statusCommentDiv').removeClass('d-none');
            }else{
                $('#statusCommentDiv').addClass('d-none');
            }
