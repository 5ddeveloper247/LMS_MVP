...
Route::group(['prefix' => 'admin/program', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/student-program-payment-plan/{program_id}/{student_id}', 'StudentSettingController@studentProgramPlan')->name('program.studentProgramPlan');
    Route::get('/student-program-payment-plan-list/{program_id}', 'StudentSettingController@studentProgramPlanList')->name('program.studentProgramPlanList');
    Route::get('/get-student-plan/{id}', 'StudentSettingController@getStudentPaymentPlan')->name('program.getStudentPaymentPlan');
    Route::post('/accept-student-plan', 'StudentSettingController@acceptStudentProgramPlan')->name('program.acceptStudentProgramPlan');
    Route::post('/reject-student-plan', 'StudentSettingController@rejectStudentProgramPlan')->name('program.rejectStudentProgramPlan');
    ...
    Route::get('/search_programs', 'StudentSettingController@search_programs')->name('searchprogram');
    Route::get('/search_details/{id}', 'StudentSettingController@search_detail')->name('searchdetail');
