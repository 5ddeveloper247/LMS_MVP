                ...
                <form action="{{ route('course.saveAddToSale') }}" method="POST" class="row" id="course_data"
                                        ...
                                        <div class="card-body row">
                                            @forelse ($chapter->lessons as $lesson)
                                                @if (!count($lesson->quiz))
                                                    <div class="col-md-12">
                                                        <label class="primary_checkbox d-flex w-100 h-auto mr-12 mb-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="primary_input mb-25">
                            <label class="primary_input_label" for="">Start Date <strong
                                    class="text-danger">*</strong></label>
                            <input class="primary-input primary_input_field date form-control" autocomplete="off"
                                {{ $errors->first('start_date') ? 'autofocus' : '' }}
                                value="{{ isset($start_date) ? getJsDateFormat($start_date) : getJsDateFormat(old('start_date')) }}" name="start_date" placeholder="-"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="primary_input mb-25">
                            ...
                            <input class="primary-input primary_input_field date form-control" autocomplete="off"
                                ...
                                value="{{ isset($end_date) ? getJsDateFormat($end_date) : getJsDateFormat(old('end_date')) }}" name="end_date" placeholder="-" type="text"
                                id="end_date">
                        </div>
                    </div>
