                        ...
                        @if ($course_plan->type == 'full_course')
                            <div class="primary_input mb-25" id="full_course_price_div">
                                ...
                                <input class="primary_input_field" accept="/^1[1-9]{9}$/" name="full_course_price"
                                    placeholder="-" type="text" maxlength="8"
                                    ...
                                    <div class="col">
                                        <div class="">
                                            <input placeholder="Date"
                                                ...
                                                value="{{ $course_plan->sdate ? monthDateYear($course_plan->sdate) : getJsDateFormat(date('m/d/Y')) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#submit_form').on('click', function(e) {
                ...
                if($('#full_course:checked').length && $('#full_course_price').val() == ''){
                    toastr.error('Full Course Price is required', 'Error');
                    return false;
                }
                if($('#prep_course_live:checked').length && $('#prep_course_live_price').val() == ''){
                    toastr.error('Prep Course (Live) Price is required', 'Error');
                    return false;
                }
