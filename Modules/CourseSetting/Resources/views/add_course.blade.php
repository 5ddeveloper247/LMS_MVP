            ...
            <div class="col-lg-12">
                ...
                <form action="{{ route('AdminSaveCourse') }}" method="POST" enctype="multipart/form-data" id="course_form">
                    ...
                    <div class="row">
                                ...
                                <div class="row toggle_course_testPrep">
                                    ...
                                    <script>
                                        ...
                                        function addcol() {
                                            ...
                                            $('.courseCodeBox').removeClass('d-block').addClass('d-none');
                                            $('.assistantBox').removeClass('d-none').addClass('d-block');
                                            $('.assistantBox').removeClass('d-none').addClass('d-block');
                                        }
                                        ...
                                        function removecol() {
                                            ...
                                            $('.courseCodeBox').removeClass('d-none').addClass('d-block');
                                            $('.assistantBox').removeClass('d-block').addClass('d-none');
                                            $('.catBox').removeClass('d-block').addClass('d-none');
                                        }
                                        ...
                                        function timecol() {
                                            ...
                                            $('.courseCodeBox').removeClass('d-none').addClass('d-block');
                                            $('.assistantBox').removeClass('d-block').addClass('d-none');
                                            $('.catBox').removeClass('d-none').addClass('d-block');
                        ...
                        <div class="col-xl-3 d-none test_prep_type">
                            <div class="primary_input mb-25">
                                ...
                                <input  min="1" step="0.1" class="primary_input_field" accept="/^1[1-9]{9}$/" name="test_prep_price"
                        ...
                        <div class="col-xl-6 courseCodeBox {{ $d_none }}">
                            <div class="primary_input mb-25">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 assistantBox {{ $d_none }}">{{-- courseBox testPrepBox  $d_none --}}
                            <div class="primary_input mb-25">
                                <label class="primary_input_label"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 catBox mb_30">
                        ...
                        <div class="col-xl-6 catBox mb_30" id="subCategoryDiv">
