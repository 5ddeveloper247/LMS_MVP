...
@if(isset($editLesson))
<input type="hidden" id="hostType{{$chapter->id}}" name="hostType" value="{{$editLesson->host ?? ''}}">
@endif
                            ...
                            <div class="defaultHost {{ isModuleActive('Org') ? 'd-none' : '' }}">
                                ...
                                $fileaccept = '';
                                 if(isset($editLesson)){
                                    ...
                                    switch (strtolower($editLesson->host)) {
                                        case 'self':
                                            # code...
                                            $fileaccept = 'video/*';
                                            break;
                                ...
                                <div class="input-effect mt-2 pt-1"
                                    ...
                                    <input type="file" class="filepond" name="file" id="hostFile{{ @$chapter->id }}" accept="{{$fileaccept}}">
                                </div>
