                ...
                <div class="col-md-12">
                    ...
                    <div class="row pt-0">
                        <ul class="nav nav-tabs no-bottom-border mt-sm-md-20 mb-10 ml-3" role="tablist">
                            ...
                            @endif
                            {{-- @if($course->type == 1 || $course->type == 9 || $course->type == 2 || $course->type == 7) --}}
                                <li class="nav-item">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="white_box_30px pl-0 pr-0 pt-0">
                                            <form action="{{ route('AdminUpdateCourse') }}" method="POST"
                                                                ...
                                                                <div class="col-md-4 col-sm-4 mb-25">
                                                                    <label class="primary_checkbox d-flex nowrap mr-12">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            value="1" class="change_state"
                                                                            {{ $test_prep_graded_price ? 'checked' : '' }}>
                                                                        <span class="checkmark mr-2"></span>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-xl-4 {{ $cna_prep_price ? '' : 'd-none' }} cna_prep_type text-center">
                                                        <div class="primary_input">
                                                    ...
                                                    <div id="test_prep_type"
                                                        ...
                                                        <div class="primary_input mb-25 mb-md-0">
                                                            ...
                                                            <input class="primary_input_field" name="test_prep_price"
                                                                id="test_prep_price1" placeholder="-" type="text" maxlength="8" 
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-xl-4 {{ $test_prep_graded_price ? '' : 'd-none' }} test_prep_graded_type text-center">
                                                        <div class="primary_input">
                                                ...
                                                <div class="row">
                                                    ...
                                                    @if($course->type != 9)
                                                    <div
                                                        class="col-xl-6 courseBox {{ $d_none }}" @if($course->type == 9) style="display:none" @endif>
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                ...
                                                <div class="row">
                                                    ...
                                                    @if (\Illuminate\Support\Facades\Auth::user()->role_id != 2 && \Illuminate\Support\Facades\Auth::user()->role_id != 9)
                                                        <div class="col-xl-6 @if($course->type == 9 || $course->type == 7 || $course->type == 2) d-none @endif">{{-- $d_none --}} {{-- $course->type == 7 ? 'd-none' : '' --}}
                                                            <div class="primary_input mb-25">
                                                                <label class="primary_input_label"
                                                    ...
                                                    <div class="col-xl-6 @if($course->type == 9 || $course->type == 7 || $course->type == 2) d-none @endif">{{-- $d_none --}}
                                                ...
                                                <div class="col-xl-12 p-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 pricetextbox {{ $course->type == 2 || $course->type == 7 || $course->type == 9 ? '' : 'd-none' }}"
                                                            ...
                                                            <div class="primary_input mb-25">
                                                                ...
                                                                <input accept="/^1[1-9]{9}$/" class="primary_input_field" maxlength="5"
                                                                @if($course->type == 9 && $course->user_id != auth()->user()->id) readonly @endif
                                                                    maxlength="8" 
                                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1').replace(/(\.\d{2})\d+/g, '$1');"
                                                        ...
                                                        <div class="col-xl-6 quizBox mb-25 @if($course->type == 7) d-none @endif" style="display: none">
                                                            <label class="primary_input_label"
                                                                                for="">
                                                                                {{ __('Select Quiz') }}
                                                                            </label>
                                                    ...
                                                    <div class="row mt-20">
                                                        <div class="col-xl-5">
                                                            <label class="primary_input_label">
                                                                Course Thumbnail (Max 2MB, Recommended 1170×600 — used for listing &amp; detail; shared across all course types)
                                                            </label>
                                                        </div>
                                                        <div class="col-xl-5">
                                                            <div class="primary_input mb-35">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="course_reviews">
                                        ...
                                        $i = 0;
                                        @endphp
                                        @foreach($course_reviews as $courseType => $courseReviews)
                                        @php
                                            
                                                switch ($courseType) {
                                                    case 2:
                                                        $reviewCourseType = '(Big Quiz)';
                                                        break;
                                                    case 3:
                                                        $reviewCourseType = '(Class)';
                                                        break;
                                                    case 4:
                                                        $reviewCourseType = '(Full Course)';
                                                        # code...
                                                        break;
                                                    case 5:
                                                        $reviewCourseType = '(Prep Course (On Demand))';
                                                        # code...
                                                        break;
                                                    case 6:
                                                        $reviewCourseType = '(Prep Course (Live))';
                                                        # code...
                                                        break;
                                                    case 7:
                                                        
                                                        $reviewCourseType = '(Time Table)';
                                                        break;
                                                    case 8:
                                                        
                                                        $reviewCourseType = '(Repeat Course)';
                                                        break;
                                                    case 9:
                                                        
                                                        $reviewCourseType = '(Individual Tutor Course)';
                                                        break;
                                                ...
                                                $i++;
                                        @endphp
                                        <h2>{{ $reviewCourseType }}</h2>
                                            <div class="erp_role_permission_area mt 30">
                                                <!-- single_permission  -->
                                                <div class="mesonary_role_header nastable" id="reviews_sortable{{ $i }}">
                                                    @foreach ($courseReviews as $thisreview)
                                                        @php
