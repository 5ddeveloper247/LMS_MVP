                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input name="title" id="title"
                                                               ...
                                                               type="text"
                                                               value="{{isset($edit)?$edit->title:old('title')}}" required>
                                                        @if ($errors->has('title'))
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input name="code" id="code"
                                                               ...
                                                               value="{{isset($edit)?$edit->code:old('code')}}" required>
                                                        @if ($errors->has('code'))
                                                            <span class="invalid-feedback d-block mb-10" role="alert">
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input name="min_purchase"
                                                               ...
                                                               value="{{isset($edit)?$edit->min_purchase:old('min_purchase')}}" required>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input name="max_discount"
                                                               ...
                                                               value="{{isset($edit)?$edit->max_discount:old('max_discount')}}" required>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input name="value"
                                                               ...
                                                               value="{{isset($edit)?$edit->value:old('value')}}" required>
                                                        @if ($errors->has('value'))
                                                            <span class="invalid-feedback d-block mb-10" role="alert">
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <select
                                                            ...
                                                            name="coupon_user_id" id="coupon_user_id" required>
                                                                ...
                                                                <div class="col">
                                                                    <div class="">
                                                                        <input placeholder="Date"
                                                                               ...
                                                                               name="start_date"
                                                                               value="{{isset($edit) ?  getJsDateFormat(date('m/d/Y', strtotime(@$edit->start_date))) : getJsDateFormat(date('m/d/Y'))}}"
                                                                ...
                                                                <div class="col">
                                                                    <div class="">
                                                                        <input placeholder="Date"
                                                                               ...
                                                                               value="{{isset($edit) ?  getJsDateFormat(date('m/d/Y', strtotime(@$edit->end_date))) : getJsDateFormat(date('m/d/Y'))}}"
                                                                               autocomplete="off" required>
                                                                    </div>
                                                                </div>
                                                                <button class="" type="button">
