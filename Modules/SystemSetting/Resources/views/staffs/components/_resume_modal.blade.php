                                    ...
                                    <tr>
                                        <td class="w-100">
                                            ...
                                            <p class="invoice_grid"
                                               style="font-size:14px; font-weight: 400; color:#3C4777;">
                                                <span
                                                    class="black_color">Current Address: </span><span>{{ $user->staff->current_address ?? '' }}</span>
                                            </p>
                                            <p class="invoice_grid"
                                               style="font-size:14px; font-weight: 400; color:#3C4777;">
                                                <span
                                                    class="black_color">Permanent Address: </span><span>{{ $user->staff->permanent_address ?? '' }}</span>
                                            </p>
                                            {{-- <p class="invoice_grid"
                                               style="font-size:14px; font-weight: 400; color:#3C4777;">
                                                <span
                                            ...
                                            <p class="invoice_grid"
                                               style="font-size:14px; font-weight: 400; color:#3C4777;">
                                                <span
                                                    class="black_color">Country: </span><span>{{$user->userCountry->name ?? ''}}</span>
                                            </p> --}}
                                            <p class="invoice_grid"
                                               style="font-size:14px; font-weight: 400; color:#3C4777;">
                                                <span
