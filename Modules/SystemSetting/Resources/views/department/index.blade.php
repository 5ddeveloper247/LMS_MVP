            ...
            $('#item_create_form').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#item_create_form').find('button[type="submit"]').prop('disabled',false);
                        $('#item_create_form').find('button[type="submit"]').find('i').attr('class', '').addClass(
                                'ti-check');
                    },
