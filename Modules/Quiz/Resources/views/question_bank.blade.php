                                    ...
                                    <div class="row mt-25">
                                        ...
                                        <div class="col-xl-4 col-md-6 mt-3 mt-md-0 d-flex flex-column justify-content-between">
                                            {{-- <div class="input-effect"> --}}
                                                ...
                                                <input {{ $errors->has('marks') ? ' autofocus' : '' }} required
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <textarea class="textArea custom_summernote" cols="30"
    ...
    <script>
        ...
        $(document).on("click", ".questionSubmitBtn", function(e) {
            ...
            if (type == 'M') {
                ...
                let option_count = $('input[name="option[]"]').length;
                let count = div.find('[type=checkbox]:checked').length;
                if(option_count<1){
                    errors.push('You need to add options for Multiple choice questions.');
                }else{
