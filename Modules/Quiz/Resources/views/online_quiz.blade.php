                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="input-effect">
                                                            ...
                                                            <input {{ $errors->has('title') ? ' autofocus' : '' }}
                                                                   ...
                                                                   value="{{isset($online_exam)? $online_exam->getTranslation('title',$language->code): ''}}" maxlength="80" @if($language->code == 'en') required @endif>
                                            ...
                                            <div class="input-effect">
                                                ...
                                                <input
                                                    ...
                                                    {{ $errors->has('title') ? ' percentage' : '' }}
                                                       ...
                                                       type="number" name="percentage" autocomplete="off" min="0" max="100"
