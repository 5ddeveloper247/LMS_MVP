                                    ...
                                    @foreach ($class->teamMeetings as $key => $meeting)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        @if ($meeting->created_by == $user->id || $user->id == $class->course->user_id)
                                                            ...
                                                            @if($meeting->cancelled == 2)
                                                                <a class="dropdown-item"
                                                                onclick="assignCancelId({{ $meeting->id }})"
                                                                href="javascript:void(0)">{{ __('Accept Cancellation') }}</a>
                                                            @endif
                                                            @else
                                                            <a class="dropdown-item"
                                                                onclick="assignCancelId({{ $meeting->id }})"
                                                ...
                                                @endif
                                                @if($meeting->cancelled == 2)
                                                <a href="javascript:void(0)" class="btn rounded border-1 small text-dark">Cancellation Requested</a>
                                                @endif
                                            </td>
                                        </tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form class="" action="{{ route('team.meetings.cancel') }}"
                                        ...
                                        <div class="text-center">
                                            ...
                                            @if(auth()->user()->role_id != 1)
                                            <textarea name="comment" class="form-control" id="cancel_comment" cols="30" rows="10"></textarea>
                                            @endif
                                        </div>
