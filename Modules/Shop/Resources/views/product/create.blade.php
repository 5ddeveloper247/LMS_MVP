        ...
        <div class="container-fluid">
            ...
            <div class="white_box mb_30">
                <div class="white_box_tittle list_header">
                    <h4>{{ __('common.Add New') }} {{ __('Product') }}</h4>
                </div>
                <div class="col-lg-12">
                    <div class="QA_section QA_section_heading_custom check_box_table">
                        <div class="QA_table">
                            ...
                            <div class="student-details header-menu">
                                ...
                                <form id="add_product_form" action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <select class="primary_select" name="is_flagship" id="is_flagship">
                                                            <option value="0" {{ (string) old('is_flagship', '0') === '0' ? 'selected' : '' }}>No</option>
                                                            <option value="1" {{ (string) old('is_flagship', '0') === '1' ? 'selected' : '' }}>Yes — show as Flagship on shop</option>
                                                        </select>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input class="primary_input_field" name="title" 
                                                            placeholder="-" type="text" value="{{ old('title') }}">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input class="primary_input_field" name="sub_title" 
                                                            placeholder="-" type="text" value="{{ old('sub_title') }}">
                                                    </div>
                                                </div>
                                                <div class="col-xl-12">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-35">
                                                ...
                                                <div class="primary_file_uploader">
                                                    <input class="primary-input filePlaceholder placeholder_txt" type="text" id="input-1" placeholder="{{ __('Upload Book') }}" readonly="">
                                                    <button class="" type="button">
                                    ...
                                    <div class="row" id="pricing_fields">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" id="tax_percent" name="tax_percent" placeholder="-"
                                                    type="number" value="{{ old('tax_percent') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" name="discount" id="discount" placeholder="-"
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-xl-10 text-center">
                                            <div class="row" id="video-preview-container"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 pt_15 text-center">
                                        <div class="d-flex justify-content-center">
                                            <button class="primary-btn semi_large2 fix-gr-bg" id="save_button"
